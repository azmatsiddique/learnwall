...
const PHONE_MODELS: Record<string, { w: number; h: number; label: string }> = {
    ...
    'samsung-s23': { w: 1080, h: 2340, label: 'Samsung Galaxy S23' },
    ...
    'samsung-s26-ultra': { w: 1440, h: 3120, label: 'Samsung Galaxy S26 Ultra' },
    'samsung-a17': { w: 1080, h: 2408, label: 'Samsung Galaxy A17' },
    'samsung-a54': { w: 1080, h: 2340, label: 'Samsung Galaxy A54' },
    'samsung-f56': { w: 1080, h: 2408, label: 'Samsung Galaxy F56 5G' },
    'samsung-m33': { w: 1080, h: 2408, label: 'Samsung Galaxy M33 5G' },
    'samsung-m55s': { w: 1080, h: 2400, label: 'Samsung Galaxy M55s 5G' },
    'pixel-8': { w: 1080, h: 2400, label: 'Google Pixel 8' },
    'pixel-8-pro': { w: 1344, h: 2992, label: 'Google Pixel 8 Pro' },
    'iqoo-12': { w: 1260, h: 2800, label: 'iQOO 12 5G' },
    'iqoo-neo-6': { w: 1080, h: 2400, label: 'iQOO Neo 6' },
    'iqoo-z6-lite': { w: 1080, h: 2408, label: 'iQOO Z6 Lite 5G' },
    'moto-edge-50-neo': { w: 1256, h: 2760, label: 'Moto Edge 50 Neo' },
    'oneplus-nord-4': { w: 1240, h: 2772, label: 'OnePlus Nord 4' },
    'oppo-reno-10': { w: 1080, h: 2412, label: 'Oppo Reno 10' },
    'oppo-reno-14': { w: 1080, h: 2412, label: 'Oppo Reno 14 5G' },
    'realme-9-pro': { w: 1080, h: 2412, label: 'Realme 9 Pro' },
    'redmi-k50i': { w: 1080, h: 2460, label: 'Redmi K50i 5G' },
    'redmi-note-10-pro-max': { w: 1080, h: 2400, label: 'Redmi Note 10 Pro Max' },
    'redmi-note-10s': { w: 1080, h: 2400, label: 'Redmi Note 10S' },
    'vivo-v29': { w: 1260, h: 2800, label: 'Vivo V29' },
    'vivo-v50': { w: 1260, h: 2800, label: 'Vivo V50' },
