...
import { Mail, Lock, Eye, EyeOff, Sparkles, ArrowRight, Github, User, Check } from 'lucide-react';
        ...
        >
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
                <motion.button
                    ...
                    className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white/5 border border-white/10 text-sm font-medium text-white hover:bg-white/10 transition-colors"
                >
